...
import com.sarm.distributed_lovable.intelligence_service.client.AccountClient;
import com.sarm.distributed_lovable.intelligence_service.entity.UsageLog;
import com.sarm.distributed_lovable.intelligence_service.repository.UsageLogRepository;
...
public class UsageServiceImpl implements UsageService {
    ...
    public void checkDailyTokensUsage() {
        ...
        if(currentUsage >= limit){
            throw  new ResponseStatusException(HttpStatus.TOO_MANY_REQUESTS,"Daily limits reached,Upgrade now");
        }
